    ...
    public bool RunRenderPhase()
    {
        ...
        if (renderPhase is LeftRenderPhase leftRenderPhase)
        {
            ...
            if (frameState.ShouldRender == 1)
            {
                ...
                var leftLayer = renderer.RenderEye(context, leftRenderPhase.HeadsetPosition, leftRenderPhase.CreateEyeRender(), inputManager.GetAimLine(AimType.Head, leftRenderPhase.VRInputData));
        ...
        else if (renderPhase is RightRenderPhase rightRenderPhase)
        {
            ...
            var rightLayer = renderer.RenderEye(context, rightRenderPhase.HeadsetPosition, rightRenderPhase.CreateEyeRender(), inputManager.GetAimLine(AimType.Head, rightRenderPhase.VRInputData));
