    ...
    public bool RunRenderPhase()
    {
        ...
        if (renderPhase is LeftRenderPhase leftRenderPhase)
        {
            ...
            if (frameState.ShouldRender == 1)
            {
                ...
                var leftLayer = renderer.RenderEye(context, leftRenderPhase.CreateEyeRender(), vrInput.GetAimLine());
        ...
        else if (renderPhase is RightRenderPhase rightRenderPhase)
        {
            ...
            var rightLayer = renderer.RenderEye(context, rightRenderPhase.CreateEyeRender(), vrInput.GetAimLine());
